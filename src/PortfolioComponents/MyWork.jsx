...
export default function MyWork() {
    ...
    return (
        <section className="bg-[#2a2b2a] py-20 w-full h-auto text-white">
            <div className="w-full flex flex-col gap-8 justify-center items-center text-white mt-5">
                <div className="flex flex-col justify-center items-center" id="mywork">
                    <h3 className="text-gray-500 text-2xl" >Solo/Group Projects</h3>
                    <Shuffle
                        text="My Work"
                        ...
                        className="font-bartle text-5xl text-white"
                    />
                </div>
                <p className="w-2/4 text-center text-gray-500">Welcome to my web development portfolio! Explore a collection of projects showcasing
                    my expertise in front-end development.</p>
            </div>
            <div className="w-full h-auto flex flex-wrap justify-center items-center mx-auto mt-10 gap-10">
                <AnimatePresence>
                                ...
                                <div className="flex items-end justify-between gap-5">
                                    <div className="w-full flex flex-wrap justify-start items-start -space-x-3">
                                        {info.tech.map((tech, num) => (
                                            <div key={num} className="w-fit h-fit px-3 py-2 scale-80 text-sm font-bold border border-white rounded-full">
                                                {tech}
                                            </div>
                                        ))}
                                    </div>
                                    <button className="absolute bottom-4 right-5 flex items-center gap-2 cursor-pointer hover:text-blue-500 text-white text-md">view <SquareArrowOutUpRight size={16} /></button>
                                </div>
                            </div>
                        </div>
                    ))}
